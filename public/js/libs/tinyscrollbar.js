;(function(window, undefined) {
    ...
    function Plugin($container, options) {
        ...
        ,   $viewport = $container.querySelectorAll(".WD__scroll__viewport")[0]
        ,   $overview = $container.querySelectorAll(".WD__scroll__overview")[0]
        ,   $scrollbar = $container.querySelectorAll(".WD__scroll__scrollbar")[0]
        ,   $track = $scrollbar.querySelectorAll(".WD__scroll__track")[0]
        ,   $thumb = $scrollbar.querySelectorAll(".WD__scroll__thumb")[0]
        ...
        this.update = function(scrollTo) {
            ...
            $scrollbar.className = this.hasContentToSroll ? scrcls.replace(/WD__scroll__disable/g, "") : scrcls.replace(/ WD__scroll__disable/g, "") + " WD__scroll__disable";
         ...
         */
        function _setCss() {
            $thumb.style["transform"] = "translate3d(0, "+ self.contentPosition + "px, 0)";
            $overview.style["transform"] = "translate3d(0, "+ (-self.contentPosition) + "px, 0)";
        ...
        function _start(event, gotoMouse) {
            if(self.hasContentToSroll) {
                ...
                $body.className += " WD__scroll__noSelect";
        ...
        function _end() {
            ...
            $body.className = $body.className.replace(" WD__scroll__noSelect", "");
